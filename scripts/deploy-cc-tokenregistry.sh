...
export CHAINCODE_IMAGE=handysama/cc_tokenregistry # path to published public chaincode docker images
export CHAINCODE_NAME=token-registry
export CHAINCODE_LABEL=token-registry
export SEQUENCE=1
export VERSION="1.0"
